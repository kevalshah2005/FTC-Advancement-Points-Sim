...
Want to run this? Create a file called constants.py and create a variable API_TOKEN that's set to your base64 encoded API key from FIRST. If you have questions on how to do this, ping CosmosAblaze (Keval) on the FTC Discord server.
